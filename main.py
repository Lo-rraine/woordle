...
def woordle(guesses, answers): 
    print("Welcome to woordle")
    ...
    while attempts <= max_attempts:
        ...
        if not is_valid_guess(guess, guesses):
            print("INVALID GUESS. MUST BE 5 WORDS IN ENGLISH")
            continue
...
guesses = load_dictionary("./assets/guesses.txt")
answers = load_dictionary("./assets/answers.txt")

woordle(guesses, answers)